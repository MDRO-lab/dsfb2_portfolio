# Parametrized COVID-19 data

Voor deze opdracht heb ik een geparametrizeerde grafiek gemaakt van COVID-19 data van de European Centre for Disease Prevention and Control (ECDC). 
...
[Video van het gebruik van deze .Rmd](https://youtu.be/H5c-RHKx-XM)

De video is een Youtube link, omdat github het niet altijd even leuk vindt om grote files op te nemen.